            ...
            {makeTemplateActive ? (
              <div className={styles.thisIsATemplate}>
                ...
                <div className={styles.thisIsRight}>
                  <button>
                    <i className="fa-regular fa-square-plus"></i> Create card
                    from template
                  </button>
            ...
            <div className={styles.winHeader}>
              <div className={styles.titleAndPlace}>
                ...
                <div className={styles.title}>
                  {!isTitleInput ? (
                    <h4 onClick={(e) => titleInputHandler(e)}>
                      Create Tasks`s UI
                    </h4>
                  ) : (
                    <input
                    ...
                    <>
                      {isTaskHidden ? (
                        <div
                          ...
                          className={styles.sideSettings}
                        >
                          <i className="fa-solid fa-arrow-rotate-left"></i> Show
                          in list
                        </div>
                      ) : (
                        <div
                          ...
                          className={styles.sideSettings}
                        >
                          <i className="fa-solid fa-box-archive"></i> Hide from
                          list
                        </div>
                      )}
